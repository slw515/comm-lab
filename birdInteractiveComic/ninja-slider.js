...
//written code
//hide button and pics and display others on first panel when "click to unlock" is pressed
function tweet() {
  document.getElementById("button1").style.display = "none";
  document.getElementById("tweetpic").style.display = "none";
  document.getElementById("pulse").style.display = "none";
  document.getElementById("finalTweet").style.display = "inline";
  document.getElementById("finalTweet").style.display = "inline";
  // document.getElementById("ninja-slider-next").style.display = "inline";
  // console.log('buttonpressed');
  document.getElementById("pulsing3").style.display = "inline";

 }

var nslider = new NinjaSlider(nsOptions);
//unhide bird shit scene and hide two buttons, change background (panel 5)
function shit() {
document.getElementById("leave").style.display = "none";
document.getElementById("button2").style.display = "none";
document.getElementById("button3").style.display = "none";
document.getElementById("shitting").style.display = "inline";
document.body.style.backgroundImage = "url('bg2.png')";
}
//destroy pulse GIF after some time specificed in HTML
function destroyPulse() {
  document.getElementById("pulsing3").style.display = "none";
}
//destroy pulse GIF after some time specificed in HTML
function destroyPulse2() {
  document.getElementById("pulsing2").style.display = "none";
}
//display pulse gif in position as well as button 4 to robot reveal
function renderPulse() {
  console.log("Hello");
  document.getElementById("pulsing").style.display = "inline";
  document.getElementById("button4").style.display = "inline";
}
//change bg and add robot reveal animation
function robot() {

  document.getElementById("pulsing").style.display = "none";
  document.getElementById("shitting").style.display = "none";
  document.getElementById("kindgif").style.display = "none";
  document.getElementById("heHears").style.display = "inline";
  document.getElementById("pulsing2").style.display = "inline";
  document.body.style.backgroundImage = "url('bg10.png')";
...
//activate gif of bird "taking the high road"
function beKind() {
  document.getElementById("leave").style.display = "none";
  document.getElementById("button2").style.display = "none";
  document.getElementById("button3").style.display = "none";
  document.getElementById("kindgif").style.display = "inline";
  document.body.style.backgroundImage = "url('bg2.png')";
...
//create variables storing information of all buttons in tab bar
var firstB = document.getElementById("firstButton");
var secondB = document.getElementById("secondButton");
var thirdB = document.getElementById("thirdButton");
var fourthB = document.getElementById("fourthButton");
var fifthB = document.getElementById("fifthButton");
var sixthB = document.getElementById("sixthButton");
//functions created to change background when each slide is clicked (uses variables)
...
fifthB.addEventListener('click', function() {
  document.body.style.backgroundImage = "url('bg7.png')";
}, false);
sixthB.addEventListener('click', function() {
  document.body.style.backgroundImage = "url('bg9.png')";
}, false);
